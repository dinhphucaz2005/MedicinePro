...
private fun Preview() {
    MedicineProTheme {
        ForgetPasswordScreen(viewModel = FakeModule.provideForgetPasswordViewModel())
    }
}

@Composable
fun ForgetPasswordScreen(modifier: Modifier = Modifier, viewModel: ForgetPasswordViewModel) {
